...
//			assertEquals(list.size(), cache.getFromCache());
	...
	private void testGetCacheTimeRangeFuture() throws IOException
	{
		...
		TimeRange tr =  TimeRange.between(System.currentTimeMillis()+ 100, System.currentTimeMillis() + 1000);
	...
	private void testGetCacheTimeRangePast() throws IOException
	{
		...
		TimeRange tr = TimeRange.between(System.currentTimeMillis() - 10000000, System.currentTimeMillis() - 1000000);
